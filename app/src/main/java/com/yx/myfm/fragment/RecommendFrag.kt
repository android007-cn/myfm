...
import com.yx.myfm.activities.RadioActivity
import com.yx.myfm.activities.RankListActivity
...
class RecommendFrag : BaseFragment(), View.OnClickListener {
    ...
    private fun initRecyclerView() {
        guess_like_recycler.layoutManager = LinearLayoutManager(AppContext.context)
        //下面代码解决滑动无惯性的问题
        guess_like_recycler.isNestedScrollingEnabled = false
        albumAdapter = AlbumAdapter(AppContext.context, mAlbumList)
